...
dirs.h = '/Users/brentfisher/Documents/MATLAB/UVQ/';
...
function INs = get_INPUT(dirs,inputfile)
    ...
    %get input
    [tmp.num,tmp.txt,tmp.raw]       =  xlsread([dirs.h,'/',inputfile], 'c3:z100' );
    [tmp2.num,tmp2.txt,tmp2.raw]    =  xlsread([dirs.h,'/',inputfile], 'c2:z2' );
