...
function A = Process_Waveguide_Loss_Overhead_Image( )
    ...
    dirs.d = '/Users/brentfisher/Documents/MATLAB/UVQ/matDat/2024_05_02_TopDown_Blue_into_WG';
    dirs.d = '/Users/brentfisher/Documents/MATLAB/UVQ/matDat/2024_05_24_OverheadBlueStreak';    
%     cd(dirs.d); [FileName,PathName] = uigetfile({'*.mat';'*.tiff'},program_name);
    ...
    hold on; plot(Rs, Baseline_blue_sorted);
